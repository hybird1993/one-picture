...
!function (t, e, i) {
    ...
    L.drawVersion = "0.4.13", L.Draw = {}, L.drawLocal = {
        draw: {
            toolbar: {
                actions: {title: "取消绘图", text: "取消"},
                finish: {title: "完成绘图", text: "完成"},
                undo: {title: "删除最后绘制的点", text: "删除最后一点"},
                buttons: {
                    polyline: "绘制折线",
                    polygon: "绘制多边形",
                    rectangle: "绘制矩形",
            ...
            handlers: {
                circle: {tooltip: {start: "点击并拖动画圆"}, radius: "半径"},
                circlemarker: {tooltip: {start: "点击地图放置圆形标记"}},
                marker: {tooltip: {start: "点击地图以放置标记"}},
                polygon: {tooltip: {start: "点击开始绘制多边形", cont: "点击以继续绘制", end: "点击第一个点闭合多边形"}},
                polyline: {
                    error: "<strong>错误:</strong>折现边缘不能交叉!",
                    tooltip: {start: "点击开始绘制折线", cont: "点击以继续绘制", end: "点击最后一个点结束绘制"}
                },
        ...
        edit: {
            toolbar: {
                actions: {
                    ...
                    cancel: {title: "取消修改，放弃所有更改", text: "取消"},
                    clearAll: {title: "清空所有图层", text: "全部清除"}
                }, buttons: {edit: "编辑图层", editDisabled: "无图层编辑", remove: "删除图层", removeDisabled: "无图层删除"}
            },
            handlers: {
                edit: {
                    tooltip: {
                ...
                }, remove: {tooltip: {text: "点击要移除的要素"}}
            }
        }
    }, L.Draw.Event = {}, L.Draw.Event.CREATED = "draw:created", L.Draw.Event.EDITED = "draw:edited", L.Draw.Event.DELETED = "draw:deleted", L.Draw.Event.DRAWSTART = "draw:drawstart", L.Draw.Event.DRAWSTOP = "draw:drawstop", L.Draw.Event.DRAWVERTEX = "draw:drawvertex", L.Draw.Event.EDITSTART = "draw:editstart", L.Draw.Event.EDITMOVE = "draw:editmove", L.Draw.Event.EDITRESIZE = "draw:editresize", L.Draw.Event.EDITVERTEX = "draw:editvertex", L.Draw.Event.EDITSTOP = "draw:editstop", L.Draw.Event.DELETESTART = "draw:deletestart", L.Draw.Event.DELETESTOP = "draw:deletestop", L.Draw.Event.TOOLBAROPENED = "draw:toolbaropened", L.Draw.Event.TOOLBARCLOSED = "draw:toolbarclosed", L.Draw = L.Draw || {}, L.Draw.Feature = L.Handler.extend({
        ...
        options: {
            ...
            shapeOptions: {stroke: !0, color: "#3388ff", weight: 4, opacity: 1, fill: !1, clickable: !0},
            metric: !0,
            feet: !0,
            nautic: !1,
            showLength: !0,
        ...
        options: {
            ...
            L.Browser.touch && (this.options.moveIcon = this.options.touchMoveIcon, this.options.resizeIcon = this.options.touchResizeIcon), this._shape = t,
